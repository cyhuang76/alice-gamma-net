...
class TestConsciousnessTemporalModulation:
    ...
    def test_low_resolution_reduces_phi(self):
        """Low temporal_resolution → Φ decreases."""
        ...
        assert r_low["raw_phi"] < r_high["raw_phi"]
...
class TestInformationOverload:
    ...
    def test_overload_reduces_consciousness(self):
        ...
        assert r_overload["raw_phi"] < r_normal["raw_phi"]
