...
?敩 **Researchers** ??A reproducible physics framework for computational neuroscience. Paper I submitted to Physical Review E.

?彞 **Medical Educators** ??Interactive simulator showing how stroke, Parkinson's, epilepsy, and PTSD emerge from impedance physics.
...
**Author**: Hsi-Yu Huang (榛冪捊瀹? ??Independent Researcher, Taiwan
