...
# Spinal Cord & Cerebellum (Phase 31+)
from alice.brain.spinal_cord import SpinalCord
from alice.brain.cerebellum import Cerebellum

# Neurogenesis Thermal Shield (Phase 31+ — Γ² thermal load distribution)
from alice.brain.neurogenesis_thermal import NeurogenesisThermalShield, ThermalFieldState
