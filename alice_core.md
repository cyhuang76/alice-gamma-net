...
> **版本**：v1.2 | **建立日期**：2026-03-16 | **上次更新**：2026-03-18 | **更新規則**：僅在重大理論突破或確立新公理時更新
...
- [x] ~~NHANES 死亡人數~~ — 已統一：n=52,545, deaths=7,627（2026-03-18）
- [x] ~~定理引用錯誤~~ — 已修正（2026-03-17 交叉引用掃描清零）
- [x] ~~P1/P2 PDF 編譯依賴問題~~ — 已修復（檔名錯誤，2026-03-18）
- [x] ~~ε = 0.03 的物理推導~~ — 已寫入 P5（perturbative first-order, 2026-03-18）
- [ ] HumanBodyModel 橋接層（三層架構串聯）
- [ ] P3/P5 跨論文 `\ref{}` 顯示為 "??"（需 `xr` package 或手動替換）
- [ ] 胚胎發育 Ω 遞增模擬（猜測，未驗證）
