...
\begin{remark}[Dynamic pathological isomorphism: \textnormal{(E0)}
  electrical vs.\ biological cascade failure]
...
\begin{remark}[Disease onset as impedance phase \textnormal{(E0)}
transition]
...
\begin{remark}[Why ``just removing the stress'' \textnormal{(E0)}
...
\begin{definition}[Thermodynamic substrate collapse \textnormal{(E0)}]
\label{def:necrosis}
...
\begin{definition}[Topological truncation \textnormal{(E0)}]
...
\begin{remark}[The therapeutic hierarchy of \textnormal{(E1)}
  intervention]
...
\begin{remark}[Structural inevitability of caregiver \textnormal{(E0)}
disease]
...
\begin{remark}[Compassion fatigue, burnout, vicarious \textnormal{(E0)}
...
\begin{remark}[Empathic overload as single-core \textnormal{(E1)}
...
\begin{remark}[Downstream convergence \textnormal{(E0)}]
...
\begin{remark}[Moral blame as secondary metabolic \textnormal{(E0)}
injury]
...
\begin{remark}[Positive-feedback closure: \textnormal{(E0)}
...
\begin{remark}[``Willpower'' as \textnormal{(E0)}
...
\begin{proposition}[Non-existence of free willpower: \textnormal{(E0)}
...
\begin{remark}[Willpower depletion as PFC bandwidth \textnormal{(E0)}
  saturation]
...
\begin{remark}[Why diet alone often fails \textnormal{(E0)}]
...
\begin{theorem}[T2DM treatment minimum: \textnormal{(E0)}
...
\begin{remark}[$\beta$-cell exhaustion as \textnormal{(E0)}
...
\begin{remark}[The exercise paradox resolved \textnormal{(E0)}]
\label{rem:exercise}
