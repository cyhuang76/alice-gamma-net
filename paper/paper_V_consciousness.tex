...
is invariant under Hebbian learning:
...
During wakefulness, active Hebbian learning maintains
...
patches hold.
During sleep, however, Hebbian updates cease
($x_{\text{pre}}\cdot x_{\text{post}}\to 0$; Paper~III),
...
The connection to impedance debt (Paper~III) is direct.
...
(Paper~IV): each day-night cycle deposits a small,
