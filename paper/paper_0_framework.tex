...
\paragraph{Willpower as bandwidth reallocation.}
...
This concentration is experienced as \emph{willpower}:
the subjective effort is real because the active
channel's $\Gamma^2 P_{\text{in}}$ at low~$T$
exceeds its cost at~$T_0$, while the $N-1$ silenced
channels surrender all fidelity.
