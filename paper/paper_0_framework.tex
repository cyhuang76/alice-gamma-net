...
The same equation ($\Gamma$, C1, C2) applies across
15~orders of magnitude in spatial scale:

\begin{table}[h]
\caption{Representative interfaces.
Full table with impedance values: Paper~5~\cite{Paper5}.}
\label{tab:scales}
\begin{ruledtabular}
\begin{tabular}{llc}
\textbf{Scale} & \textbf{Interface} & \textbf{Size} \\
\hline
$25$\,nm    & Microtubule junction      & molecular \\
$1$\,$\mu$m & Ion channel / membrane    & cellular \\
$10$\,$\mu$m & Synapse                  & cellular \\
$100$\,$\mu$m & Arteriole bifurcation   & tissue \\
$1$\,mm     & Cortical column boundary  & organ \\
$1$\,cm     & Organ capsule             & organ \\
$10$\,cm    & Joint (bone--cartilage)   & body \\
$1$\,m      & Whole body (skin--air)    & organism \\
$10$\,m     & Power line splice         & engineering \\
$1$\,km     & Optical fibre connector   & engineering \\
$10^3$\,km  & Submarine cable joint     & infrastructure \\
$10^6$\,m   & Ionospheric waveguide     & planetary \\
\end{tabular}
\end{ruledtabular}
\end{table}
