...
Source code:
\texttt{alice/body/tissue\_blueprint.py} (blueprints),
\texttt{tests/test\_e0\_cardiovascular.py} (13~tests),
\texttt{tests/test\_e0\_neural.py} (17~tests).
All 30 tests pass with 100\% rate.
...
under AGPL-3.0.
The full test suite comprises 3{,}313 automated tests
with 100\% pass rate.
