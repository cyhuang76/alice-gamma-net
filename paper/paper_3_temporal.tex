...
The $\Gamma$-framework does not explain \emph{why}
this convergence occurred---natural selection does---but
it identifies the \emph{physical constraints} that
any nervous system must satisfy.
