...
The nineteen $\Gamma$-networks (Table~\ref{tab:nineteen})
...
emerge.''
We test this with two tissue blueprints (\texttt{GammaTopology}
instances with biologically assigned \texttt{TissueType} and
mode count~$K$) and pure perturbations of initial conditions.
...
The 30 E0 tests (13~cardiovascular + 17~neural) prove
