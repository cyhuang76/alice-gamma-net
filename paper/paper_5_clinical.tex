...
Table~\ref{tab:nineteen} maps all twenty-nine known
...
% ============================================================
\section{Physical Uniqueness of C2 and Evolutionary Compatibility}
\label{sec:evolution}
...
This is a mathematical result, not an evolutionary claim.
The $\Gamma$-framework predicts \emph{what} the optimal
update rule must be; natural selection determines
\emph{whether} a given lineage implements it.
That ten unrelated molecular machineries converge on the
same equation is consistent with C2 being a physical
attractor in the space of possible update rules.
