...
We therefore identify \textbf{five mutually irreducible
...
The organ-level health metric therefore generalises from
the dual product $H = \Tn\,\Tv$ (Eq.~\ref{eq:dual_health})
to
\begin{equation}
  H_{\text{org}} = \prod_{s=1}^{5}(1-\Gamma_s^2)\,,
  \label{eq:quintuple_health}
\end{equation}
where $s$ indexes the five subsystems.
